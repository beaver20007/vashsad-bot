...
- main = `a0bba9767eff6b8fa69654a0eb85c78e98f1be47` (merge PR #7: убраны
  выдуманные цены из FAQ AI-чата), синхронизирован с origin.
- Обновлено: 2026-08-18. PR #5, #6, #7 смёржены по подтверждению
  владельца, задеплоены на Railway (автодеплой из git), живая проверка
  через Telegram Web пройдена по всем пунктам — F1.2 архитектурно
  закрыта: единственный путь заказа — Mini App, ноль неаудированных
  источников цен в боте.
