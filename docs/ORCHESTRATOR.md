...
- main = `3b891f43c45b60564b1cb0eca3d9ad1de175136d` (merge PR #3
  fix/await-get-pool), синхронизирован с origin (`git rev-parse HEAD` после
  `git reset --mixed origin/main` совпал с `git rev-parse origin/main`).
- Обновлено: 2026-08-11, трек INC-1 (продолжение) + новый баг quick_order.
