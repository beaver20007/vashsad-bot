...
FAQ_PATTERNS = [
    {
        ...
        'answer': (
            ...
            "• Дендроплан — от 5 000 ₽\n"
            "• Эскизный проект — от 15 000 ₽\n"
            "• Полный проект — от 30 000 ₽\n"
            "• Авторский надзор — от 3 000 ₽/выезд\n\n"
            "Точная стоимость зависит от площади и сложности. "
            "Закажите консультацию — рассчитаю под ваш участок! 🌿"
        ),
    },
    {
